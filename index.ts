const PARAPHRASE_URL = "http://localhost:3000/paraphrase";
const JSON_HEADERS = {
  "Content-Type": "application/json",
};

const SHORT_TEXT = `qbpdelim123
...
const postParaphrase = (text: string): void => {
  fetch(PARAPHRASE_URL, {
    method: "POST",
...
const main1 = (): void => {
  postParaphrase(SHORT_TEXT);
};

const main = (): void => {
  postParaphrase(LONG_TEXT);
};
